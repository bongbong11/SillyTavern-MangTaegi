...
export async function init() {
    ...
    const panelHtml = `
    <div id="mangtaegi_container" class="extension_container">
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                ...
                <hr>
                <button id="mt-scan-btn" class="menu_button" style="width:100%;">🔍 전체 채팅 스캔</button>
                <div id="mt-npc-list" style="margin-top:8px;max-height:400px;overflow-y:auto;">
